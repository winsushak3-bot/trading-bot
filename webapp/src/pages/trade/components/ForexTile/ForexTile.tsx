...
interface ForexTileProps {
  onClick?: () => void;
}

export const ForexTile = ({ onClick }: ForexTileProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 relative z-10">
        ...
        <div>
          <p className="text-white text-sm font-bold">Forex</p>
          <p className="text-zinc-500 text-[11px]">{t('trade.currencies')}</p>
        </div>
      </div>
    </button>
  );
